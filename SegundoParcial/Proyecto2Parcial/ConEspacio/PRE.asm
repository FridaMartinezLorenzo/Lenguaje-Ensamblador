...
COMAND_D PROC
   ...
   MOV BL,[SI]
   CMP BL,0DH ;SI ES UN ENTER SE DESPLIEGAN 80 BYTES DESDE LA ULTIMA DIR
   JE B_LASTDIR
   ...
   MOV BH,DIRECCION_H
   MOV BL,DIRECCION_L ;RESPALDAMOS DIRECCION INICIAL
   
   CMP BL,20H ;TIENE QUE EXISTIR UN ESPACIO
   JNE SINTAX_ERROR_D
   ;DEFINIMOS EL CASO DE QUE ES POR RANG0 
   INC SI
   MOV BL,[SI]
   CALL IS_A_NUM ;FALTA SI SE METE UN ENTER 
   CMP AH,0 ;BANDERA APAGADA
   ...
   MOV AH,DIRECCION_H
   MOV AL,DIRECCION_L
   ;MOV CX,AX ;DESPALDAMOS DIRECCION FINAL
   SUB AX,BX ; EN AL VA A QUEDAR EL RES Y ESTE SERA E N BYTES A DESPLEGAR
   LEA DI,[BX]
   CALL DESPLIEGA_MEM
...
DESPLIEGA_MEM PROC
  ...
  PUSH SI
    ...
    ;AH TIENE EL NUMERO DE BYTES A DESPLEGAR
    MOV CH,AH
 ...
 DESPLIEGA_SIG_BYTE:   
    MOV AL,[DI] ;LEEMOS EL DATO EN MEMORIA Y CONVERTIR
    CALL ASCII_BINARIO 
    CMP AL,28H
    JNE CONTINUA1D
    MOV AL,00H ;CORRIGE
    ...
    INC DI ;NOS SALTAMOS EL ESPACIO QUE SE GUARD? (LO QUITO?)
